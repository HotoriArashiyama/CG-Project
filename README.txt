...
How to control:
  ...
  Mouse wheel for generally zooming the objects in the scene.
  Left click to choose an operable object in the scene, and left click again to cancel.
...
Implemented in this branch:
  ...
  Layout.h: including skybox, terrain, providing interface for Control to operate the object by mouse click, providing interface for .obj loading.
